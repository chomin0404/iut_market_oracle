...
class TestBuildGraph:
    def test_shape(self) -> None:
        ...
        W = _build_graph(doppler, sigma=1.5)
        assert W.shape == (4, 4)
    ...
    def test_symmetric(self) -> None:
        ...
        W = _build_graph(doppler, sigma=1.0)
    ...
    def test_sigma_affects_weights(self) -> None:
        ...
        W_narrow = _build_graph(doppler, sigma=0.5)
        W_wide = _build_graph(doppler, sigma=5.0)
...
class TestComputeRoc:
    ...
    def test_auc_in_range(self) -> None:
        ...
        _, _, auc = _compute_roc(scores, labels)
        assert 0.0 <= auc <= 1.0
